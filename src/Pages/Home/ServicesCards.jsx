...
const ServicesCards = () => {
    ...
    return (
        <div className='flex flex-col text-center gap-4 my-32'>
        ...
        <div className="card w-96 bg-base-100 border border-opacity-50 rounded-lg" key={ _id }>
            ...
            <div className="card-body font-bold">
                ...
                <div className="flex w-full items-center">
                    ...
                    <Link to={ `/service/${ _id }` }><AiOutlineArrowRight className='text-primary p-4 hover:bg-primary hover:bg-opacity-10 duration-150 box-content rounded-full' /></Link>
                </div>
            </div>
        </div>
    );
